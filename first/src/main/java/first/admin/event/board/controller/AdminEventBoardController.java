package first.admin.event.board.controller;
...
public class AdminEventBoardController {
	...
	@RequestMapping(value="/admin/board/openEventBoardList.do")
    public ModelAndView openBoardList(Map<String,Object> commandMap) throws Exception{ 
		ModelAndView mv = new ModelAndView(".tiles/admin/eventList"); 
				
		return mv; 
	} 	
	
	@RequestMapping(value="/admin/board/selectEventBoardList.do")
	public ModelAndView selectBoardList(CommandMap commandMap) throws Exception{
		ModelAndView mv = new ModelAndView("jsonView");
		
		List<Map<String,Object>> list = adminBoardService.selectEventBoardList(commandMap.getMap());
	...
	@RequestMapping(value = "/admin/board/openEventBoardWrite.do")
	public ModelAndView openBoardWrite(CommandMap commandMap) throws Exception {
		ModelAndView mv = new ModelAndView(".tiles/admin/eventWrite");
		
		return mv;
	}	

	@RequestMapping(value = "/admin/board/insertEventBoard.do")
	public ModelAndView insertBoard(CommandMap commandMap, HttpServletRequest request) throws Exception {
		ModelAndView mv = new ModelAndView("redirect:/admin/board/openEventBoardList.do");
	...
	@RequestMapping(value = "/admin/board/openEventBoardDetail.do")
	public ModelAndView openBoardDetail(CommandMap commandMap) throws Exception {
		ModelAndView mv = new ModelAndView(".tiles/admin/eventDetail");
	...
	@RequestMapping(value = "/admin/board/openNohitEventBoardDetail.do")
	...
	@RequestMapping(value="/admin/board/openEventBoardUpdate.do")
	public ModelAndView openBoardUpdate(CommandMap commandMap) throws Exception{
		ModelAndView mv = new ModelAndView(".tiles/admin/eventUpdate");
	...
	@RequestMapping(value="/admin/board/updateEventBoard.do")
	...
	@RequestMapping(value = "/admin/board/deleteEventBoard.do")
	...
	/* 댓글컨트롤러 */	
	@ResponseBody
	@RequestMapping(value = "/admin/board/openCommentEventBoardList.do", method = RequestMethod.GET)
	...
	@RequestMapping(value="/admin/board/selectCommentEventBoardList.do")
	...
	@RequestMapping(value = "/admin/board/insertCommentEventBoard.do")
	public ModelAndView insertCommentBoard(CommandMap commandMap) throws Exception {
		ModelAndView mv = new ModelAndView("redirect:/admin/board/openNohitEventBoardDetail.do");
	...
	@RequestMapping(value="/admin/board/updateCommentEventBoard.do")
	...
	@RequestMapping(value = "/admin/board/commentEventBoardDelete.do")
