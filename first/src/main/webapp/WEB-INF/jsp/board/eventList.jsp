...
<body>
	...
	<script type="text/javascript">
		...
		function fn_openBoardWrite(){
			...
			comSubmit.setUrl("<c:url value='/board/openEventBoardWrite.do' />");
			comSubmit.submit();
		}
		
		function fn_openBoardDetail(obj){
			var comSubmit = new ComSubmit();
			comSubmit.setUrl("<c:url value='/board/openEventBoardDetail.do' />");
		...
		function fn_selectBoardList(pageNo){
			...
			comAjax.setUrl("<c:url value='/board/selectEventBoardList.do' />");
