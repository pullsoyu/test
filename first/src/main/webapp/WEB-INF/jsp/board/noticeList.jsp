...
<!-- 	<a href="#this" class="btn" id="write">글쓰기</a> -->
	...
	<script type="text/javascript">
		...
		function fn_openBoardWrite(){
			...
			comSubmit.setUrl("<c:url value='/board/openNoticeBoardWrite.do' />");
			comSubmit.submit();
		}
		
		function fn_openBoardDetail(obj){
			var comSubmit = new ComSubmit();
			comSubmit.setUrl("<c:url value='/board/openNoticeBoardDetail.do' />");
		...
		function fn_selectBoardList(pageNo){
			...
			comAjax.setUrl("<c:url value='/board/selectNoticeBoardList.do' />");
