...
<div class="container">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			function fn_openGoodsKind2PA(obj){
				var comSubmit = new ComSubmit();
				comSubmit.setUrl("<c:url value='/goods/grainListPA.do' />");
				comSubmit.addParam("GOODS_IDX", obj.parent().find("#IDX").val());
				comSubmit.submit();
			}

			function fn_openGoodsKind2PD(obj){
				var comSubmit = new ComSubmit();
				comSubmit.setUrl("<c:url value='/goods/grainListPD.do' />");
				comSubmit.addParam("GOODS_IDX", obj.parent().find("#IDX").val());
				comSubmit.submit();
			}

			function fn_openGoodsKind2RD(obj){
				var comSubmit = new ComSubmit();
				comSubmit.setUrl("<c:url value='/goods/grainListRD.do' />");
				comSubmit.addParam("GOODS_IDX", obj.parent().find("#IDX").val());
				comSubmit.submit();
			}

			function fn_openGoodsKind2ID(obj){
				var comSubmit = new ComSubmit();
				comSubmit.setUrl("<c:url value='/goods/grainListID.do' />");
				comSubmit.addParam("GOODS_IDX", obj.parent().find("#IDX").val());
				comSubmit.submit();
			}
		...
		function fn_selectBoardList(pageNo){
			var comAjax = new ComAjax();
			comAjax.setUrl("<c:url value='/goods/selectGrainListID.do' />");
