...
<div class="container">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			function fn_openGoodsKind3PA(obj){
				var comSubmit = new ComSubmit();
				comSubmit.setUrl("<c:url value='/goods/meatListPA.do' />");
				comSubmit.addParam("GOODS_IDX", obj.parent().find("#IDX").val());
				comSubmit.submit();
			}

			function fn_openGoodsKind3PD(obj){
				var comSubmit = new ComSubmit();
				comSubmit.setUrl("<c:url value='/goods/meatListPD.do' />");
				comSubmit.addParam("GOODS_IDX", obj.parent().find("#IDX").val());
				comSubmit.submit();
			}

			function fn_openGoodsKind3RD(obj){
				var comSubmit = new ComSubmit();
				comSubmit.setUrl("<c:url value='/goods/meatListRD.do' />");
				comSubmit.addParam("GOODS_IDX", obj.parent().find("#IDX").val());
				comSubmit.submit();
			}

			function fn_openGoodsKind3ID(obj){
				var comSubmit = new ComSubmit();
				comSubmit.setUrl("<c:url value='/goods/meatListID.do' />");
				comSubmit.addParam("GOODS_IDX", obj.parent().find("#IDX").val());
				comSubmit.submit();
			}
		...
		function fn_selectBoardList(pageNo){
			var comAjax = new ComAjax();
			comAjax.setUrl("<c:url value='/goods/selectMeatListPA.do' />");
