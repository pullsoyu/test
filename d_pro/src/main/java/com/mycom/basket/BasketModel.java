...
public class BasketModel {
			...
			private String basket_goods_image; 
			...
			public String getBasket_goods_image() {
				return basket_goods_image;
			}
			public void setBasket_goods_image(String basket_goods_image) {
				this.basket_goods_image = basket_goods_image;
			}
